...
public class DeleteChef extends JFrame {

	private JPanel contentPane;
	private JPanel panel;	
	private JMenuBar chefMenuBar ;
	private JMenu OrderMenu,FileMenu,RestaurantMenu,ManagerMenu,FoodMenu,ChefMenu;
	private JMenuItem AcceptOrderMenuItem,DisconnectMItem,PreparedOrderMenuItem,CloseMItem,EditRestaurantMItem,EditManagerItem,CreateFoodMenuItem,EditFoodMenuItem,DeleteFoodMenuItem,CreateChefMenuItem,EditChefMenuItem;
	...
	public DeleteChef() {
		...
		lblTitle1.setBounds(202, 56, 430, 73);
		panel.add(lblTitle1);
		

		ImageIcon icon6 = new ImageIcon("Images/DELETECHEF.png");
		...
		btnDelete.setBounds(528, 512, 189, 33);
		panel.add(btnDelete);		
		
		TxtRestName = new JTextField();
		TxtRestName.setEditable(false);
		TxtRestName.setColumns(12);
		TxtRestName.setBounds(526, 183, 191, 22);
		panel.add(TxtRestName);
		
		lblRestaurantName = new JLabel("Restaurant Name :");
		lblRestaurantName.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblRestaurantName.setBounds(322, 176, 171, 33);
		panel.add(lblRestaurantName);
		
		lblSelectChef = new JLabel("Select Chef :");
		lblSelectChef.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblSelectChef.setBounds(119, 142, 134, 33);
		panel.add(lblSelectChef);
		
		ChefComboBox = new JComboBox();
		ChefComboBox.setBounds(82, 210, 191, 33);
		...
		textArea.setBounds(63, 188, 220, 177);
		panel.add(textArea);
	...
	/**
	 * @param chefComboBox the chefComboBox to set
	 */
