...
public class EditDeliveryGuy extends JFrame {
	...
	private JButton btnAddDeliveryArea,btnDeleteDeliveryArea,btnEdit;
	...
	private JMenuItem DisconnectMItem,CloseMItem,CreateRestaurantMItem,EditRestaurantMItem,DeleteRestaurantMItem,CreateDeliveryManMItem,DeleteDeliveryManMItem,CreateManagerItem,EditManagerItem,DeleteManagerItem,CreateFoodMenuItem,EditFoodMenuItem,DeleteFoodMenuItem;
	private JTextField txtuname,TxtPhoneNo;
	private JPasswordField passwordField;
	private JPasswordField cpasswordField;
	private JComboBox DeliveryManComboBox;
	private JTextArea textArea;
	private JLabel lblSelectDeliveryMan;

	
	/**
	 * Create the frame.
	 */
	public EditDeliveryGuy() {
		...
		lblCreateMenu.setBounds(156, 53, 542, 76);
		panel.add(lblCreateMenu);
		
		ImageIcon icon6 = new ImageIcon("Images/EDITDELIVERYGUY.png");
		...
		btnAddDeliveryArea.setBounds(603, 533, 140, 36);
		...
		btnDeleteDeliveryArea.setBounds(439, 535, 152, 34);
		...
		btnEdit.setBounds(523, 600, 140, 33);
		panel.add(btnEdit);	
		
		passwordField = new JPasswordField();
		passwordField.setEditable(false);
		passwordField.setBounds(539, 199, 204, 24);
		panel.add(passwordField);
		
		cpasswordField = new JPasswordField();
		cpasswordField.setEditable(false);
		cpasswordField.setBounds(539, 243, 204, 24);
		panel.add(cpasswordField);
		
		DeliveryManComboBox = new JComboBox();
		DeliveryManComboBox.setBounds(77, 210, 204, 33);
		...
		textArea.setBounds(55, 195, 247, 199);
		panel.add(textArea);
		
		lblSelectDeliveryMan = new JLabel("Select Delivery Man :");
		lblSelectDeliveryMan.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblSelectDeliveryMan.setBounds(77, 149, 204, 33);
		panel.add(lblSelectDeliveryMan);
