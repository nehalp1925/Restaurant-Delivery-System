...
public class AddMenu extends JFrame {
	...
	private JMenuItem DisconnectMItem,CloseMItem,CreateRestaurantMItem,EditRestaurantMItem,DeleteRestaurantMItem,CreateDeliveryManMItem,EditDeliveryManMItem,DeleteDeliveryManMItem,CreateManagerItem,EditManagerItem,DeleteManagerItem,EditFoodMenuItem,DeleteFoodMenuItem,CreateChefMenuItem,EditChefMenuItem,DeleteChefMenuItem;
	...
	public AddMenu() {
		...
		lblTitle1.setFont(new Font("Tahoma", Font.BOLD, 25));
		lblTitle1.setBounds(164, 53, 470, 71);
		panel.add(lblTitle1);
		

		ImageIcon icon6 = new ImageIcon("Images/NEWMENU.png");
		...
		textArea.setBounds(100, 203, 230, 190);
		panel.add(textArea);
		...
		textArea_1.setBounds(480, 201, 230, 190);
		...
		textArea_2.setBounds(260, 470, 295, 190);
